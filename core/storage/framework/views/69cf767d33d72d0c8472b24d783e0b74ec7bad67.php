                            ...
                            <div class="d-flex justify-content-between align-items-end flex-wrap gap-2">
                                ...
                                <div class="form-group flex-fill">
                                    ...
                                    <select class="form-control" name="accommodation" id="accommodation" required>
                                        <?php if(request()->accommodation_id): ?>
                                        <?php
                                ...
                                <div class="form-group flex-fill">
                                    ...
                                    <input autocomplete="off" class="form-control bg--white" name="date" placeholder="<?php echo app('translator')->get('Select Date'); ?>" required type="date">
                                </div>
                                <div class="form-group flex-fill">
                                    <label><?php echo app('translator')->get('Room'); ?></label>
                                    <input class="form-control" name="rooms" placeholder="<?php echo app('translator')->get('How many room?'); ?>" required type="text" value="1" readonly>
                                </div>
                                ...
                                <div class="form-group flex-fill">
                                    ...
                                    <select class="form-control" name="bed_type_id" id="bed_type_id" required>
                                        ...
                                        ?>
                                        <?php $__currentLoopData = $bed_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bed_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($bed_type->id); ?>"><?php echo e($bed_type->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                    </select>
                                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="pb-3">
                        ...
                        <span><?php echo app('translator')->get('Cleaning'); ?></span>
                        <span class="fas fa-circle text--warning"></span>
                        <span><?php echo app('translator')->get('Under Maintenance'); ?></span>
                    </div>
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.room.book')); ?>" class="booking-form" id="booking-form" method="POST">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="user_id">
                                    <option value="<?php echo e($user->id); ?>"><?php echo e($user->firstname); ?></option>
                                </select>
                            </div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div id="user-div" class="col-12 d-none">
                            ...
                            <div class="col-12 guestInputDiv">
                                <div class="form-group">
                                    <label><?php echo app('translator')->get('SAP ID/ Employee ID'); ?></label>
                            ...
                            <div class="col-12 guestInputDiv">
                                <div class="form-group">
                                    <label><?php echo app('translator')->get('Nationality'); ?></label>
                                    <input class="form-control forGuest" name="nationality" required type="text">
                                </div>
                            </div>
                            <div class="col-12 guestInputDiv">
                                <div class="form-group">
                                    <label><?php echo app('translator')->get('Passport/Iqama'); ?></label>
                                ...
                                <div class="form-group">
                                    <label><?php echo app('translator')->get('Gender'); ?></label>
                                     <select class="form-control" name="gender">
                                        <option selected value="male"><?php echo app('translator')->get('Male'); ?></option>
                            ...
                            <div class="col-12 guestInputDiv">
                                <div class="form-group">
                                    <label><?php echo app('translator')->get('Contact Number'); ?></label>
                                    <input class="form-control forGuest" name="mobile" required type="text">
                                </div>
                            </div>
                            <div class="col-12 guestInputDiv">
                                <div class="form-group">
                                    <label><?php echo app('translator')->get('Car Plate No'); ?></label>
                            ...
                            <div class="col-12 guestInputDiv">
                                <div class="form-group">
                                    <label><?php echo app('translator')->get('Main Company'); ?></label>
                                    <input class="form-control forGuest" name="company" required type="text">
                                </div>
                            </div>
                            <div class="col-12 guestInputDiv">
                                <div class="form-group">
                                    <label><?php echo app('translator')->get('Project Site'); ?></label>
    ...
    <script>
        ...
        $('#accommodation').change(function () {
            ...
            if (accommodationId) {
                 ...
                 $.get('<?php echo e(route('admin.hotel.room.type.roomType', ['accommodation_id' => ':accommodation_id'])); ?>'.replace(':accommodation_id', accommodationId), function (data) {
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home5/efsimsa/public_html/neomliving.efsim.sa/core/resources/views/admin/booking/book.blade.php ENDPATH**/ ?>