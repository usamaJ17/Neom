          ...
          <div class="modal-dialog" role="document">
              <div class="modal-content">
                  <div class="modal-header">
                      <h5 class="modal-title"><?php echo app('translator')->get('Merging with'); ?>: <span class="booking-with"></span></h5>
                  ...
                  <form action="" method="post">
                      ...
                      <div class="modal-body">
                          ...
                          <div class="form-group">
                              <label class="required"><?php echo app('translator')->get('Booking Number'); ?></label>
                              <div class="d-flex">
  ...
  <?php $hasPermission = App\Models\Role::hasPermission('admin.booking.key.handover')  ? 1 : 0;
      ...
      <div class="modal fade" id="keyHandoverModal" role="dialog" tabindex="-1">
          <div class="modal-dialog" role="document">
              <div class="modal-content">
                  <div class="modal-header">
                      <h5 class="modal-title"><?php echo app('translator')->get('Key Handover'); ?></h5>
                      <button aria-label="Close" class="close" data-bs-dismiss="modal" type="button">
                          <i class="las la-times"></i>
                      </button>
                  </div>
                  <form action="" method="post">
                      <?php echo csrf_field(); ?>
                      <div class="modal-body">
                          <p class="fw-bold"> <?php echo app('translator')->get('Rooms'); ?></p>
                          <div class="bookedRooms"></div>
                      </div>

                      <div class="modal-footer">
                          <button class="btn btn--primary w-100 h-45" type="submit"><?php echo app('translator')->get('Handover Now'); ?></button>
                      </div>
                  </form>
              </div>
          </div>
      ...
      <script>
          (function($) {
              ...
              $(document).on('click', '.mergeBookingBtn', function(e) {
                  ...
                  form.action = `<?php echo e(route('admin.booking.merge', '')); ?>/${$(this).data('id')}`
              ...
              $(document).on('click', '.handoverKeyBtn', function() {
                ...
                `);
                  ...
                  modal.find('form').attr('action', `<?php echo e(route('admin.booking.key.handover', '')); ?>/${data.id}`);
                  modal.modal('show');
              });
          })(jQuery);
      </script>
  ...
  <?php $__env->stopPush(); ?>
<?php /**PATH /home5/efsimsa/public_html/neomliving.efsim.sa/core/resources/views/admin/booking/partials/modals.blade.php ENDPATH**/ ?>