                        ...
                        <table class="table--light style--two table" id="datatable">
                            <thead>
                                <tr>
                                    ...
                                    <?php $hasPermission = App\Models\Role::hasPermission(['admin.hotel.amenity.*'])  ? 1 : 0;
            if($hasPermission == 1): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <?php $hasPermission = App\Models\Role::hasPermission('admin.hotel.amenity.save')  ? 1 : 0;
            if($hasPermission == 1): ?>
                                                    <button class="btn btn-sm btn-outline--primary cuModalBtn" data-has_status="1" data-modal_title="<?php echo app('translator')->get('Update Amenity'); ?>" data-resource="<?php echo e($item); ?>" type="button">
                                                        <i class="la la-pencil"></i><?php echo app('translator')->get('Edit'); ?>
                                                    </button>
                                                <?php endif ?>
                                                <?php $hasPermission = App\Models\Role::hasPermission('admin.hotel.amenity.status')  ? 1 : 0;
            if($hasPermission == 1): ?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"> <?php echo app('translator')->get('Add Amenties'); ?></h5>
                        <button aria-label="Close" class="close" data-bs-dismiss="modal" type="button">
                            <i class="las la-times"></i>
                        </button>
                    </div>
                    <form action="<?php echo e(route('admin.hotel.amenity.save')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php $hasPermission = App\Models\Role::hasPermission('admin.hotel.amenity.save')  ? 1 : 0;
    ...
    <?php $__env->startPush('breadcrumb-plugins'); ?>
        <button class="btn btn-sm btn-outline--primary cuModalBtn" data-modal_title="<?php echo app('translator')->get('Add New Amenity'); ?>" type="button">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home5/efsimsa/public_html/neomliving.efsim.sa/core/resources/views/admin/hotel/amenities.blade.php ENDPATH**/ ?>